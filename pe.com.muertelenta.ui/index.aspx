			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" id="form1" runat="server">
					...
					<div class="wrap-input100 validate-input" data-validate = "Ingrese el nombre de usuario">
						<input class="input100" type="text" id="username" name="username" placeholder="Usuario" runat="server"/>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Ingrese la clave">
						<input class="input100" type="password" id="pass" name="pass" placeholder="Clave" runat="server"/>
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
